...
# 127.0.0.1:3001/profile/{name}  {name} = จะใส่ชื่ออะไรก็ได้
...
def get_query_parameter(start: int = 0, limit: int = 0):
    return JSONResponse(
        content={"message": f"start: {start} limit: {limit}"}, status_code=200
    )
...
if __name__ == "__main__":
    ...
    # True เหมาะกับ DVE เมื่อกด save หน้าเว็บเปลี่ยน
